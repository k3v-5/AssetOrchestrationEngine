"""calibrate_player_tucked_stock.py
Posiciona el subfusil con la culata apoyada de forma realista en el hombro derecho de SK_Player
(buffer seguro, cero clipping) y ambas manos perfectamente acopladas en sus respectivas empuñaduras.
"""
import bpy
import math
import shutil
...
# Torso táctico: inclinado ligeramente hacia adelante, perfilado
...
# Brazo derecho: culata ceñida al hombro
...
pb_ur.rotation_euler = (math.radians(-16), math.radians(4), math.radians(-14))
pb_fr.rotation_euler = (math.radians(-78), math.radians(-6), math.radians(8))
pb_hr.rotation_euler = (math.radians(14), math.radians(-8), math.radians(-2))

# Brazo izquierdo: alcanzando la empuñadura vertical Tommy
...
pb_ul.rotation_euler = (math.radians(-32), math.radians(-14), math.radians(34))
pb_fl.rotation_euler = (math.radians(-68), math.radians(18), math.radians(-14))
pb_hl.rotation_euler = (math.radians(12), math.radians(22), math.radians(15))

# Piernas: postura táctica de combate
...
out_img = r"E:\Darx_Proyect\Art\Blender\calibrate_player_tucked_stock.png"
scene.render.filepath = out_img
bpy.ops.render.render(write_still=True)
shutil.copyfile(out_img, r"C:\Users\sasuk\.gemini\antigravity\brain\695523dc-0f49-434f-b134-d3298443b0f2\calibrate_player_tucked_stock.png")
print("Rendered calibrate_player_tucked_stock.png")
