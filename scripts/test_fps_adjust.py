...
v_world = Vector((0.04, -0.34, 0.10))
pb_u.location = b_u.matrix_local.to_3x3().inverted() @ v_world

# Rotations to grasp vertical foregrip
pb_u.rotation_euler = (math.radians(-14), math.radians(8), math.radians(14))
pb_f.rotation_euler = (math.radians(-38), math.radians(-12), math.radians(-8))
pb_h.rotation_euler = (math.radians(24), math.radians(-20), math.radians(40))
...
out_img = r'C:\Users\sasuk\.gemini\antigravity\brain\695523dc-0f49-434f-b134-d3298443b0f2\test_fps_grasp_adjusted.png'
